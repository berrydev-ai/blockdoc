...
- New `markdownToBlockDoc` converter for transforming Markdown documents to BlockDoc format
...
- Example implementation in `examples/markdown-conversion/index.js`
